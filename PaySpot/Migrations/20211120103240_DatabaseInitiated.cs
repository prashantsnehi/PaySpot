...
{
    public partial class DatabaseInitiated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KycImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KycInfo_AspNetUsers_AppUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidenceAddressInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResidenceAddressInfo_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorePincode = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkInfo_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KycInfo_AppUsersId",
                table: "KycInfo",
                column: "AppUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_ResidenceAddressInfo_AppUsersId",
                table: "ResidenceAddressInfo",
                column: "AppUsersId",
                unique: true,
                filter: "[AppUsersId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_WorkInfo_AppUsersId",
                table: "WorkInfo",
                column: "AppUsersId",
                unique: true,
                filter: "[AppUsersId] IS NOT NULL");
